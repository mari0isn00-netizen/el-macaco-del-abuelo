  ...
  return (
    <article className="overflow-hidden rounded-2xl border border-border bg-[#fffaf3] text-[#2f241d] shadow-sm print:border-0 print:shadow-none">
      <div className="border-b border-[#d8c6ae] bg-[#f4eadb] px-6 py-7 sm:px-10">
        ...
        <h1 className="mt-3 font-serif text-3xl font-bold sm:text-4xl">Contrato de estancia privada</h1>
        <p className="mt-3 max-w-2xl text-sm leading-6 text-[#6d5a49]">
          Alojamiento independiente en Las Monjas, parcela 121, Carmona, Sevilla. Este documento recoge las
          condiciones esenciales de la estancia antes de formalizar la reserva.
        </p>
      </div>
      ...
      <div className="space-y-6 px-6 pb-8 sm:px-10">
        <section>
          ...
          <p className="mt-2 text-sm leading-7">
            La casa, El Macaco del Abuelo, ofrece una estancia privada en Las Monjas, parcela 121, Carmona, Sevilla.
            La persona huésped principal es <strong>{reservation.guest_name}</strong>
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold">2. Fechas, ocupación y alcance</h2>
          <p className="mt-2 text-sm leading-7">
            ...
            {reservation.guests === 1 ? "huésped" : "huéspedes"}. Cualquier modificación de fechas, número de personas
        ...
        <section>
          ...
          <p className="mt-2 text-sm leading-7">
            El importe de esta estancia es <strong>{priceText}</strong>. La casa lo establece tras revisar las fechas
            solicitadas, la duración de la estancia, la disponibilidad y las condiciones concretas del uso.
          </p>
          <p className="mt-2 text-sm leading-7">
            El precio incluye el uso privado del apartamento independiente, piscina, jacuzzi, jardín, parcela exterior,
            mobiliario disponible, menaje básico, zonas de descanso y comunicación directa con la casa por el chat web.
            No incluye servicios no descritos expresamente ni actividades, visitas o eventos no autorizados.
          </p>
        </section>

        <section>
          <h2 className="font-serif text-xl font-semibold">4. Señal, reserva y confirmación</h2>
          <p className="mt-2 text-sm leading-7">
            ...
            Mientras se utilice Bizum personal, el pago quedará pendiente de comprobación bancaria por parte de la casa.
          </p>
        </section>
        ...
        <section>
          <h2 className="font-serif text-xl font-semibold">6. Uso responsable de la estancia</h2>
          <p className="mt-2 text-sm leading-7">
            La estancia se destina a descanso privado y uso familiar. No se permiten fiestas, eventos no autorizados,
            actividades molestas, exceso de ocupación ni usos que puedan dañar la vivienda, piscina, jacuzzi, jardín,
            mobiliario, menaje o parcela. Cualquier incidencia o daño deberá comunicarse cuanto antes por el chat web.
          </p>
        </section>

        <section>
          <h2 className="font-serif text-xl font-semibold">7. Privacidad y presencia de los propietarios</h2>
          <p className="mt-2 text-sm leading-7">
            Los propietarios estarán en la casa principal de la parcela durante la estancia. Esa presencia no altera la
            privacidad del alojamiento: no saldrán ni intervendrán salvo que los huéspedes necesiten ayuda, pidan algo
            o exista una incidencia que requiera atención.
          </p>
        </section>
