...
export function buildContractText(reservation: Reservation): string {
  ...
  return [
    ...
    "La casa: El Macaco del Abuelo, apartamento independiente dentro de una parcela familiar compartida con los dueños en Las Monjas, parcela 121, Carmona, Sevilla.",
    ...
    "Los propietarios estarán en la casa principal de la parcela durante la estancia. Esa presencia forma parte del carácter cercano del alojamiento: supervisión discreta, ayuda si se solicita y respeto por el descanso de los huéspedes.",
    "",
